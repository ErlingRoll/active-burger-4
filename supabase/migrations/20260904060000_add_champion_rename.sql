-- Champions remain immutable build snapshots. Only their display name may
-- change after creation; build fields are never client-editable.

create function public.rename_champion(
  p_champion_id text,
  p_name text
)
returns table (
