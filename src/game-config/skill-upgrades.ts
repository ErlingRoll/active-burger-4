...
export const INITIAL_UPGRADES: readonly UpgradeDefinition[] = [
  ...
  },
  {
    ...
    rarity: Rarity.Common,
    amount: 1,
    valueLabel: `+${FIERY_TOUCH_LEVEL_DAMAGE_INCREASE_PERCENT}% Fiery Touch damage`,
    skillId: FIERY_TOUCH_SKILL_ID,
    skillAction: 'level',
  ...
  },
  {
    ...
    rarity: Rarity.Common,
    amount: 1,
    valueLabel: `+${AEGIS_PULSE_LEVEL_DAMAGE_INCREASE_PERCENT}% damage, +${AEGIS_PULSE_SHIELD_AMOUNT_PER_LEVEL} shield`,
    skillId: AEGIS_PULSE_SKILL_ID,
    skillAction: 'level',
