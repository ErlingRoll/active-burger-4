...
export const SYNERGY_UPGRADES: readonly SynergyUpgradeDefinition[] = [
  ...
  createSynergyUpgrade(
    ...
    'Piercing Vanguard',
    'Rift Javelin and Lancer\'s Charge deal 18% increased damage while both skills are equipped.',
    '+18% Rift Javelin and Lancer\'s Charge damage',
    [RIFT_JAVELIN_SKILL_ID, LANCERS_CHARGE_SKILL_ID],
    damageEffects([RIFT_JAVELIN_SKILL_ID, LANCERS_CHARGE_SKILL_ID], 18),
  ),
  createSynergyUpgrade(
    'synergy-cinder-mine-fiery-touch',
    'Wildfire',
    'Cinder Mine and Fiery Touch deal 18% increased damage while both skills are equipped.',
    '+18% Cinder Mine and Fiery Touch damage',
    [CINDER_MINE_SKILL_ID, FIERY_TOUCH_SKILL_ID],
    damageEffects([CINDER_MINE_SKILL_ID, FIERY_TOUCH_SKILL_ID], 18),
  ),
  createSynergyUpgrade(
    'synergy-soul-tether-vitality',
    'Lifebound Pact',
    'Soul Tether and Vitality restore 20% more health.',
    '+20% Soul Tether and Vitality healing',
    [SOUL_TETHER_SKILL_ID, VITALITY_SKILL_ID],
    [
      { skillId: SOUL_TETHER_SKILL_ID, healingIncreasePercent: 20 },
      { skillId: VITALITY_SKILL_ID, healingIncreasePercent: 20 },
    ],
  ),
  createSynergyUpgrade(
    ...
    'Phantom Arsenal and Raise Skeleton deal 18% increased damage while both skills are equipped.',
    '+18% Phantom Arsenal and Skeleton damage',
    [PHANTOM_ARSENAL_SKILL_ID, RAISE_SKELETON_SKILL_ID],
    damageEffects([PHANTOM_ARSENAL_SKILL_ID, RAISE_SKELETON_SKILL_ID], 18),
  ),
  createSynergyUpgrade(
    'synergy-storm-relay-rallying-standard',
    'Warded Conduit',
    'Storm Relay deals 18% increased damage and Rallying Banner restores 15% more health.',
    '+18% Storm Relay damage, +15% Rallying Banner healing',
    [STORM_RELAY_SKILL_ID, RALLYING_STANDARD_SKILL_ID],
    [
      { skillId: STORM_RELAY_SKILL_ID, damageIncreasePercent: 18 },
      { skillId: RALLYING_STANDARD_SKILL_ID, healingIncreasePercent: 15 },
    ],
  ),
  createSynergyUpgrade(
    'synergy-rift-javelin-cinder-mine',
    'Scorched Lance',
    'Rift Javelin and Cinder Mine deal 18% increased damage while both skills are equipped.',
    '+18% Rift Javelin and Cinder Mine damage',
    [RIFT_JAVELIN_SKILL_ID, CINDER_MINE_SKILL_ID],
    damageEffects([RIFT_JAVELIN_SKILL_ID, CINDER_MINE_SKILL_ID], 18),
  ),
  createSynergyUpgrade(
    'synergy-cinder-mine-storm-relay',
    'Ashen Circuit',
    'Cinder Mine and Storm Relay deal 18% increased damage while both skills are equipped.',
    '+18% Cinder Mine and Storm Relay damage',
    [CINDER_MINE_SKILL_ID, STORM_RELAY_SKILL_ID],
    damageEffects([CINDER_MINE_SKILL_ID, STORM_RELAY_SKILL_ID], 18),
  ),
  createSynergyUpgrade(
    'synergy-storm-relay-soul-tether',
    'Voltaic Bond',
    'Storm Relay and Soul Tether deal 18% increased damage while both skills are equipped.',
    '+18% Storm Relay and Soul Tether damage',
    [STORM_RELAY_SKILL_ID, SOUL_TETHER_SKILL_ID],
    damageEffects([STORM_RELAY_SKILL_ID, SOUL_TETHER_SKILL_ID], 18),
  ),
  createSynergyUpgrade(
    'synergy-soul-tether-phantom-arsenal',
    'Spectral Pact',
    'Soul Tether and Phantom Arsenal deal 18% increased damage while both skills are equipped.',
    '+18% Soul Tether and Phantom Arsenal damage',
    [SOUL_TETHER_SKILL_ID, PHANTOM_ARSENAL_SKILL_ID],
    damageEffects([SOUL_TETHER_SKILL_ID, PHANTOM_ARSENAL_SKILL_ID], 18),
  ),
  createSynergyUpgrade(
    'synergy-phantom-arsenal-rift-javelin',
    'Ghost Volley',
    'Phantom Arsenal and Rift Javelin deal 18% increased damage while both skills are equipped.',
    '+18% Phantom Arsenal and Rift Javelin damage',
    [PHANTOM_ARSENAL_SKILL_ID, RIFT_JAVELIN_SKILL_ID],
    damageEffects([PHANTOM_ARSENAL_SKILL_ID, RIFT_JAVELIN_SKILL_ID], 18),
  ),
]
