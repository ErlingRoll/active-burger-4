...
export const RALLYING_BANNER_AREA_OF_EFFECT_PER_RANK = 15
...
export const VITALITY_HEALING_PER_LEVEL = 5
...
export const STORM_RELAY_CONDUIT_PULL_RADIUS = 120
...
// Synergy tuning shared by interaction hooks.
...
export const BASIC_ATTACK_VITALITY_TRIGGER_COOLDOWN_SECONDS = 0.75
export const BASIC_ATTACK_LANCER_HIT_INTERVAL = 3
export const BASIC_ATTACK_LANCER_TRIGGER_COOLDOWN_SECONDS = 0.5
export const BASIC_ATTACK_WHIRLWIND_COOLDOWN_REDUCTION_PERCENT = 50
export const BASIC_ATTACK_RAISE_SKELETON_COOLDOWN_REDUCTION_SECONDS = 0.2
export const BASIC_ATTACK_FIERY_TOUCH_COOLDOWN_REDUCTION_SECONDS = 0.15
export const BASIC_ATTACK_PHANTOM_COOLDOWN_REDUCTION_SECONDS = 0.2
export const BASIC_ATTACK_COOLDOWN_TRIGGER_INTERVAL_SECONDS = 0.3
export const BASIC_ATTACK_BANNER_EXTENSION_SECONDS = 0.1
export const BASIC_ATTACK_BANNER_TRIGGER_INTERVAL_SECONDS = 0.3
export const BASIC_ATTACK_GRAVITY_PULL_DISTANCE = 6
export const BASIC_ATTACK_GRAVITY_TRIGGER_INTERVAL_SECONDS = 0.15
export const BASIC_ATTACK_AEGIS_RESTORE_RATIO = 0.02
export const BASIC_ATTACK_AEGIS_TRIGGER_INTERVAL_SECONDS = 0.3
export const BASIC_ATTACK_RIFT_HIT_INTERVAL = 4
export const BASIC_ATTACK_RIFT_RETURN_BONUS_PERCENT = 15
export const BASIC_ATTACK_CINDER_ARM_RANGE = 120
export const BASIC_ATTACK_SOUL_HEALING_RATIO = 0.05
export const BASIC_ATTACK_SOUL_TRIGGER_INTERVAL_SECONDS = 0.3
export const BASIC_ATTACK_SIGIL_STORED_DAMAGE_RATIO = 0.25
export const BASIC_ATTACK_SIGIL_TRIGGER_INTERVAL_SECONDS = 0.25
export const BASIC_ATTACK_MIRROR_REFRESH_SECONDS = 0.1
export const BASIC_ATTACK_MIRROR_TRIGGER_INTERVAL_SECONDS = 0.5
export const BASIC_ATTACK_RAZOR_TRIGGER_INTERVAL_SECONDS = 0.3
export const BASIC_ATTACK_BLOOD_EXTENSION_SECONDS = 0.15
export const BASIC_ATTACK_BLOOD_MAX_DURATION_BONUS_SECONDS = 4
export const BASIC_ATTACK_BLOOD_TRIGGER_INTERVAL_SECONDS = 0.35
export const BASIC_ATTACK_PRISM_TRIGGER_INTERVAL_SECONDS = 0.2
export const BASIC_ATTACK_PRISM_COOLDOWN_REDUCTION_SECONDS = 0.05
export const FRACTURED_CIRCUIT_BONUS_CHARGE = 1
export const PARALLAX_TEMPEST_DAMAGE_RATIO = 0.45
export const FROSTLINE_RADIUS = 30
...
export const ASHEN_LEGION_GUARD_DURATION_SECONDS = 4
export const ASHEN_LEGION_SPLASH_DAMAGE_RATIO = 0.3
export const ASHEN_LEGION_SPLASH_RADIUS = 60
export const SCORCHING_LIFELINE_DAMAGE_RATIO = 0.2
export const SCORCHING_LIFELINE_TRIGGER_COOLDOWN_SECONDS = 1
export const VANGUARD_STANDARD_BANNER_EXTENSION_SECONDS = 0.5
export const ECHO_WELL_DAMAGE_RATIO = 0.45
export const CRIMSON_BULWARK_SHIELD_RATIO = 0.25
export const CRIMSON_BULWARK_MAX_SHIELD_PERCENT = 30
export const AURORA_RELAY_DAMAGE_RATIO = 0.5
...
export const SKILL_DEFINITIONS = {
  ...
  [CHAIN_LIGHTNING_SKILL_ID]: {
    ...
    description: 'Launches a lightning bolt that chains between nearby enemies.',
    kind: 'projectile',
    tags: ['lightning', 'projectile', 'triggerable'],
    canProduceDirectHit: true,
    mirrorcastEligible: true,
    cooldown: 3,
    ...
    jumpRange: 225,
    maxTargets: 6,
    projectileDefinitionId: CHAIN_LIGHTNING_PROJECTILE_DEFINITION_ID,
    spreadDegrees: 8,
    effectLifetime: 0.18,
    visual: {
      kind: 'projectile',
  ...
  [VITALITY_SKILL_ID]: {
    ...
    baseDamage: {},
    baseHealing: 6,
    healingPerLevel: VITALITY_HEALING_PER_LEVEL,
    effectLifetime: 0.3,
    visual: {
      kind: 'utility',
      icon: '♥',
  ...
  [FIERY_TOUCH_SKILL_ID]: {
    ...
    canProduceDirectHit: true,
    // Fiery Touch is a direct-hit trigger rather than an independently cast skill.
    mirrorcastEligible: false,
    cooldown: 2,
    baseDamage: { fire: 10 },
    radius: 80,
  ...
  [PHANTOM_ARSENAL_SKILL_ID]: {
    ...
    kind: 'utility',
    tags: ['physical', 'projectile', 'summon', 'duration'],
    canProduceDirectHit: true,
    mirrorcastEligible: false,
    cooldown: 6,
    baseDamage: {},
  ...
  [MIRRORCAST_SKILL_ID]: {
    ...
    name: 'Mirrorcast',
    description: `Weaves a fragile Echo. The next mirrorable non-Basic skill you cast is copied after a short delay at ${Math.round(MIRRORCAST_BASE_EFFECTIVENESS * 100)}% effectiveness, without resetting the original cooldown. Mirrorcast can never copy itself.`,
    kind: 'utility',
    tags: ['trigger'],
    canProduceDirectHit: true,
    mirrorcastEligible: false,
