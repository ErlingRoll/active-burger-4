            ...
            <div className="hub-left-dock">
              ...
              */}
              ...
              <nav className="hub-paths" aria-label="Elsewhere in the refuge">
                <button className="hub-path" type="button" onClick={onOpenChampions} title="Saved builds" disabled={runLoadState !== 'ready'} {...navigationControlProps(navigation, 'champions')}>
                  <span aria-hidden="true">◆</span>
                  <span>Champions</span>
                </button>
                <button className="hub-path" type="button" onClick={onOpenInventory} title="Fish, gear, and loot" disabled={runLoadState !== 'ready'} {...navigationControlProps(navigation, 'inventory')}>
                  <span aria-hidden="true">▣</span>
                  <span>Inventory</span>
                </button>
                <button className="hub-path" type="button" onClick={onOpenShop} title="Buy and sell supplies" disabled={runLoadState !== 'ready'} {...navigationControlProps(navigation, 'shop')}>
                  <span aria-hidden="true">⇄</span>
                  <span>Quartermaster</span>
                </button>
                <button className="hub-path" type="button" onClick={onOpenRunHistory} title="Runs already ended" disabled={runLoadState !== 'ready'} {...navigationControlProps(navigation, 'run-history')}>
                  <span aria-hidden="true">✦</span>
                  <span>Chronicle</span>
                </button>
              </nav>
