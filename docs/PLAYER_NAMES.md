...
3. A component-specific fallback (`fallback`)
4. `Anonymous player`
...
precedence. The fishing active-angler function is updated in
`supabase/migrations/20260906010000_use_canonical_player_names.sql`.
